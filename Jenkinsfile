pipeline {
    ...
    stages {
        ...
        stage('21i-1103 Build') {
            steps {
                bat 'docker-compose -f C:\\Users\\samii\\Downloads\\scd-final-lab-exam-31304-master\\scd-final-lab-exam-31304-master\\DockerCompose.yml up --build -d FinalLabExam'
            }
        }
        stage('21i-1103 Push') {
            steps {
